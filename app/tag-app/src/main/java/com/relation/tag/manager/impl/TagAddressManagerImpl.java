...
public class TagAddressManagerImpl implements TagAddressManager {
    ...
    private void tag(String batchDate, String filePath) throws Exception {
        ...
        if (!checkResult("address_label", batchDate, 63, true)) {
        ...
        check("address_label", 60 * 1000, batchDate, 63, true);
        tagMerge(batchDate);
    }
...
//        log.info("exceSelectSql======={},retVal=============={}",checkSql,retVal);
    ...
    private void basicData(String batchDate, String filePath) {
        ...
        execSql("basic_data", "data_cal_token_platform.sql", batchDate, filePath,13,true, null,false );
        execSql("basic_data", "data_cal_nft_platform.sql", batchDate, filePath,13,true, null, false);
    }
