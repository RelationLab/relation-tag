...
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('o3','Bid','Bid','Bid','1','token');
...
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('o6','Lend','Lend','Lend','1','token');
...
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('o3','Bid','Bid','Bid','0','token');
...
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('o6','Lend','Lend','Lend','0','token');
