...
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a1','Buy','Buyer','Buy','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a2','Sale','Seller','Sale','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a3','Bid','Bid','Bid','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('a4','Deposit','Deposit','Deposit','0','token');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type,asset_type) values('a5','Withdraw','Withdraw','Withdraw','0','token');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a6','Lend','Lend','Lend','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a7','Burn','Burner','Burn','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a8','Mint','Minter','Mint','0');
insert into nft_trade_type_temp(code,nft_trade_type,nft_trade_type_name,nft_trade_type_alis,type) values('a9','Transfer','Transfer','Transfer','0');
