...
vacuum address_label_token_balance_rank;

insert into public.address_label_token_balance_rank(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type)
    select
    tb1.address ,
    tb2.label_type,
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_token_balance_rank' as table_name,'${batchDate}'  as batch_date;
