...
vacuum address_label_univ3_balance_rank;

insert into public.address_label_univ3_balance_rank(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type)
select
    tb1.address ,
    tb2.label_type,
                                        ...
                                        from
                                            (
                                                ...
                                                where
                                                  ...
                                                  and balance_usd >= 100
                                                  and type = 'lp' and address not in (select address from exclude_address)  and address <> '0x0000000000000000000000000000000000000000') s1
                                ...
                                from
                                    (
                                        ...
                                        where
                                                project = '0xc36442b4a4522e871399cd717abdd847ab11fe88'
                                          and balance_usd >= 100
                                          and type = 'lp'  and address not in (select address from exclude_address)) tbvu2
                                group by
                                    token) as a10
                            on
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_univ3_balance_rank' as table_name,to_char(current_date ,'YYYY-MM-DD')  as batch_date;
