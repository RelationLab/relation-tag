...
vacuum
address_label_univ3_balance_rank;

insert into public.address_label_univ3_balance_rank(address, label_type, label_name, data, wired_type, updated_at,
...
SELECT 'address_label_univ3_balance_rank' as table_name, '${batchDate}' as batch_date;
