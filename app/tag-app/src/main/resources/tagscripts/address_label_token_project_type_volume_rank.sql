...
vacuum
address_label_token_project_type_volume_rank;

insert into public.address_label_token_project_type_volume_rank(address, label_type, label_name, data, wired_type,
                  ...
                  from (select a1.id,
                        ...
                        from (select md5(cast(random() as varchar)) as id,
                                     ...
                                     row_number()                      over(partition by seq_flag,recent_time_code
					                        order by total_transfer_volume_usd desc,address asc) as count_sum, recent_time_code
...
SELECT 'address_label_token_project_type_volume_rank' as table_name, '${batchDate}' as batch_date;
