...
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_active_users union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_defi_active_users union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_defi_high_demander union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_elite union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_long_term_holder union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_nft_active_users union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_nft_high_demander union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_nft_whale union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_token_whale union all
select address,label_type,label_name,data,updated_at,'-1' as owner,'SYSTEM' as source  from  address_label_crowd_web3_active_users union all
