...
insert into public.address_label_univ3_volume_rank(address,label_type,label_name,data,wired_type,updated_at,group,level,category,trade_type,project,asset)
    select
    tb1.address,
    tb2.label_type,
