...
insert into public.address_label_token_balance_grade(address,label_type,label_name,data,wired_type,updated_at,group,level,category,trade_type,project,asset)
    select
    address,
    a2.label_type,
