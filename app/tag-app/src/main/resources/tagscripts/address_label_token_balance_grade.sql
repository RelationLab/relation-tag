...
vacuum
address_label_token_balance_grade;
...
from (select address,
      ...
      from token_balance_volume_usd_temp tbvutk) a1
         inner join
...
SELECT 'address_label_token_balance_grade' as table_name, '${batchDate}' as batch_date;
