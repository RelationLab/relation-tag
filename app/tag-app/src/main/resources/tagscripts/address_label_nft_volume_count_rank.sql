...
vacuum address_label_nft_volume_count_rank;

insert into public.address_label_nft_volume_count_rank(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type, recent_time_code )
select
    address ,
    label_type,
                                ...
                                from
                                    (
                                        ...
                                        group by
                                            ...
                                            and a10.type = a1.type) as a2) as t1 ) tb1 inner join dim_project_token_type_temp dptt
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_nft_volume_count_rank' as table_name,'${batchDate}'  as batch_date;
