...
vacuum
address_label_nft_balance_usd_top;

insert into public.address_label_nft_balance_usd_top(address, label_type, label_name, data, wired_type, updated_at,
...
SELECT 'address_label_nft_balance_usd_top' as table_name, '${batchDate}' as batch_date;
