...
CREATE TABLE public.address_label_nft_transfer_volume_count_rank (
                                                                     ...
                                                                     asset varchar(50) NULLL
);
truncate table public.address_label_nft_transfer_volume_count_rank;
insert into public.address_label_nft_transfer_volume_count_rank(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset)
select
    address ,
    label_type,
