...
vacuum
address_label_usdt_volume_rank;
      ...
      from (select a2.address,
            ...
            from (select a1.address,
                  ...
                  from (select a1.address,
					...
					address asc) as count_sum, a1.recent_time_code
...
where tb2.data_subject = 'volume_rank'
  and tb2.token_type = 'token'
  and zb_rate <= 0.1;
insert into tag_result(table_name, batch_date)
SELECT 'address_label_usdt_volume_rank' as table_name, '${batchDate}' as batch_date;
