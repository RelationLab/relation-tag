...
vacuum
address_label_web3_type_balance_grade;
...
select address,
       label_type,
       label_type || case
                         when balance = 1 then '8a'
                         when balance >= 2
                             and balance < 4 then '8b'
                         when balance >= 4
                             and balance < 11 then '8c'
                         when balance >= 11
                             and balance < 51 then '8d'
                         when balance >= 51
                             and balance < 101 then '8e'
                         when balance >= 101 then '8f'
           end                               as label_name,
       balance                               as data,
       'WEB3'                                as wired_type,
       now()                                 as updated_at,
...
SELECT 'address_label_web3_type_balance_grade' as table_name, '${batchDate}' as batch_date;
