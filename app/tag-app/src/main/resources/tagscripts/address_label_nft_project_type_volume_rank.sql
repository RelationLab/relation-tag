...
vacuum
address_label_nft_project_type_volume_rank;

insert into public.address_label_nft_project_type_volume_rank(address, label_type, label_name, data, wired_type,
...
SELECT 'address_label_nft_project_type_volume_rank' as table_name, '${batchDate}' as batch_date;
