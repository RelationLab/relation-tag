...
insert into public.address_label_nft_balance_rank(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type)
select
    address,
    label_type,
    label_type || '_' || case
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_nft_balance_rank' as table_name,'${batchDate}'  as batch_date;
