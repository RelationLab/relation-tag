...
from
    (
        select
            ...
            type
        from
            dex_tx_volume_count_summary_univ3_temp tbvutk
        where
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_univ3_balance_grade' as table_name,'${batchDate}'  as batch_date;
