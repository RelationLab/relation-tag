...
vacuum
address_label_usdt_balance_rank;

insert into public.address_label_usdt_balance_rank(address, label_type, label_name, data, wired_type, updated_at,
...
from (select t1.address,
     ...
     on
         tb1.token = tb2.token
where tb1.zb_rate <= 0.1
  and tb2.data_subject = 'balance_rank'
  and tb2.token_type = 'token';
insert into tag_result(table_name, batch_date)
SELECT 'address_label_usdt_balance_rank' as table_name, '${batchDate}' as batch_date;
