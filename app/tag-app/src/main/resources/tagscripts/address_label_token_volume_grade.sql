...
vacuum
address_label_token_volume_grade;

insert into public.address_label_token_volume_grade(address, label_type, label_name, data, wired_type, updated_at,
...
from (select address,
             ...
             recent_time_code
      from token_volume_usd_temp tbvutk) a1
         inner join
...
SELECT 'address_label_token_volume_grade' as table_name, '${batchDate}' as batch_date;
