...
insert into public.address_label_token_balance_top_all(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset)
    select
    s1.address,
    s1.label_type,
