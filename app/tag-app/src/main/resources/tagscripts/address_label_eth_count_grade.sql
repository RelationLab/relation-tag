...
vacuum
address_label_eth_count_grade;

insert into public.address_label_eth_count_grade(address, label_type, label_name, data, wired_type, updated_at, "group",
...
from (select address,
             ...
             recent_time_code
      from eth_holding_vol_count_temp th1) a1
         inner join
...
SELECT 'address_label_eth_count_grade' as table_name, '${batchDate}' as batch_date;
