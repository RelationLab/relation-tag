...
vacuum address_label_token_time_special;
...
insert into public.address_label_token_time_special(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type)
    ...
    (
        select
            ...
            counter
        from
            token_holding_time_temp tbvutk
        where
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_token_time_special' as table_name,'${batchDate}'  as batch_date;
