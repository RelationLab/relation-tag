...
vacuum
address_label_token_volume_grade_all;

insert
into public.address_label_token_volume_grade_all(address,
                                                 label_type,
                                                 label_name,
                                                 data,
                                                 wired_type,
...
SELECT 'address_label_token_volume_grade_all' as table_name, '${batchDate}' as batch_date;
