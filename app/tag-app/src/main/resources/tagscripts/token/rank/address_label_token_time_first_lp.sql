...
insert into public.address_label_token_time_first_lp (address,label_type,label_name,updated_at)
    select
    s1.address,
    s1.label_type,
	...
	order by
        ...
        from
            (select * from
                dex_tx_volume_count_summary where type='lp' and balance_usd>0) a1
