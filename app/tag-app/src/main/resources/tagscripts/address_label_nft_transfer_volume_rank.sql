...
vacuum
address_label_nft_transfer_volume_rank;
            ...
            from (select a2.address,
                  ...
                  from (select a1.address,
                        ...
                        from (select a1.address,
                                     a1.seq_flag,
                                     a1.total_transfer_volume,
                                     row_number() over(partition by a1.seq_flag,a1.recent_time_code
					                        order by total_transfer_volume desc,address asc) as count_sum, a1.recent_time_code
...
SELECT 'address_label_nft_transfer_volume_rank' as table_name, '${batchDate}' as batch_date;
