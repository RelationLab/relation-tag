...
vacuum address_label_univ3_volume_grade;

insert into public.address_label_univ3_volume_grade(address,label_type,label_name,data,wired_type,updated_at,"group",level,category,trade_type,project,asset,bus_type, recent_time_code )
select
    a1.address,
    a2.label_type,
...
insert into tag_result(table_name,batch_date)  SELECT 'address_label_univ3_volume_grade' as table_name,'${batchDate}'  as batch_date;
