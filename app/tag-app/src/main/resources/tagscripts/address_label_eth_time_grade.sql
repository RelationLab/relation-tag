...
vacuum
address_label_eth_time_grade;

insert into public.address_label_eth_time_grade(address, label_type, label_name, data, wired_type, updated_at, "group",
...
SELECT 'address_label_eth_time_grade' as table_name, '${batchDate}' as batch_date;
