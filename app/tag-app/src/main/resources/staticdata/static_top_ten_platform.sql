DROP TABLE if EXISTS  static_top_ten_platform;
create table static_top_ten_platform
(
...
truncate table static_top_ten_platform;
vacuum static_top_ten_platform;

insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type) values ('ALL',0,'ALL','web3','balance');
...
insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type) values ('ALL',0,'ALL','nft','volume');
----platform defi vol
insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type)
select
...
insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type) values ('ALL',0,'ALL','defi','activity');
insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type) values ('ALL',0,'ALL','nft','activity');
insert into static_top_ten_platform(token,rownumber,token_name,token_type,bus_type) values ('ALL',0,'ALL','web3','activity');
