...
insert
into public.label_factor_seting_temp
(dict_code,
 dict_name,
 parent_id,
 dict_level,
 dict_type,
 dict_describe)
select symbol || '(' || substring(address,
                                  1,
                                  8) || ')' as dict_code,
       symbol                               as dict_name,
       8                                    as parent_id,
...
select (lpt.symbol1 || '/' || lpt.symbol2) || '(' || SUBSTRING(lpt.pool, 1, 8) || ')' as dict_code,
       lpt.factory_content                                                            as dict_name,
       'asset_LP'                                                                     as dict_type
...
SELECT 'dim_label_factor_seting' as table_name, '${batchDate}' as batch_date;
