drop table if exists snapshot_token_holding;

CREATE TABLE public.snapshot_token_holding (
...
truncate table snapshot_token_holding;
vacuum snapshot_token_holding;
insert into snapshot_token_holding(address ,
                          "token" ,
                          balance ,
                          block_height ,
...
select address ,
       ...
       total_transfer_all_count,
       total_transfer_to_volume ,
       total_transfer_all_volume from token_holding;
