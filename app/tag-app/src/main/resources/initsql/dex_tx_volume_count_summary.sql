update snapshot_dex_tx_volume_count_record set project='0x1111111254fb6c44bac0bed2854e76f90643097d'
                                          where project='0x1111111254fb6c44bAC0beD2854e76F90643097d';

update snapshot_dex_tx_volume_count_record set token='eth'
where (project='0x1111111254fb6c44bAC0beD2854e76F90643097d'
...
from
    snapshot_dex_tx_volume_count_record  dtvcr
        inner join (
        select
            *
        from
