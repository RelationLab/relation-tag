...
insert into tag_result(table_name,batch_date)  SELECT 'address_labels_json_gin_${tableSuffix}_${tableSuffix}' as table_name,to_char(current_date ,'YYYY-MM-DD')  as batch_date;
