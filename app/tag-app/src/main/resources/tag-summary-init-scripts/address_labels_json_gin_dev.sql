...
SELECT address,
       JSONB_BUILD_OBJECT(
               ...
               'l', (max(CASE WHEN recent_time_code = 'ALL' THEN data ELSE null END))::JSONB,
               'd3l', (max(CASE WHEN recent_time_code = '3d' THEN data ELSE null END))::JSONB,
               'd7l', (max(CASE WHEN recent_time_code = '7d' THEN data ELSE null END))::JSONB,
               'd15l', (max(CASE WHEN recent_time_code = '15d' THEN data ELSE null END))::JSONB,
               'm1l', (max(CASE WHEN recent_time_code = '1m' THEN data ELSE null END))::JSONB,
               'm3l', (max(CASE WHEN recent_time_code = '3m' THEN data ELSE null END))::JSONB,
               'm6l', (max(CASE WHEN recent_time_code = '6m' THEN data ELSE null END))::JSONB,
               'y1l', (max(CASE WHEN recent_time_code = '1y' THEN data ELSE null END))::JSONB,
               'y2l', (max(CASE WHEN recent_time_code = '2y' THEN data ELSE null END))::JSONB,
               'ul', (max(CASE WHEN recent_time_code = 'ul' THEN data ELSE null END))::JSONB,
               'opl', (max(CASE WHEN recent_time_code = 'opl' THEN data ELSE null END))::JSONB,
