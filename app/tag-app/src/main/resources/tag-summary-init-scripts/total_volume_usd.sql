-- public.total_volume_usd_temp definition
-- Drop table
-- DROP TABLE public.total_volume_usd_temp;
DROP TABLE IF EXISTS public.total_volume_usd_temp;
CREATE TABLE public.total_volume_usd_temp (
...
truncate table total_volume_usd_temp;
vacuum total_volume_usd_temp;

insert into total_volume_usd_temp(address, volume_usd,recent_time_code)
